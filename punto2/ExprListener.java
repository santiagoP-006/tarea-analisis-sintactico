...
public interface ExprListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterRestaExpr(ExprParser.RestaExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code RestaExpr}
	 * labeled alternative in {@link ExprParser#e}.
	 * @param ctx the parse tree
	 */
	void exitRestaExpr(ExprParser.RestaExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code MultiplicacionExplicita}
	 * labeled alternative in {@link ExprParser#t}.
	 * @param ctx the parse tree
	 */
	void enterMultiplicacionExplicita(ExprParser.MultiplicacionExplicitaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MultiplicacionExplicita}
	 * labeled alternative in {@link ExprParser#t}.
	 * @param ctx the parse tree
	 */
	void exitMultiplicacionExplicita(ExprParser.MultiplicacionExplicitaContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code MultiplicacionImplicita}
	 * labeled alternative in {@link ExprParser#t}.
	 * @param ctx the parse tree
	 */
	void enterMultiplicacionImplicita(ExprParser.MultiplicacionImplicitaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MultiplicacionImplicita}
	 * labeled alternative in {@link ExprParser#t}.
	 * @param ctx the parse tree
	 */
	void exitMultiplicacionImplicita(ExprParser.MultiplicacionImplicitaContext ctx);
	/**
